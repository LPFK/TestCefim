 ...
 */
class getGroupsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GroupsRepository' shared autowired service.
     *
     * @return \App\Repository\GroupsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GroupsRepository.php';

        return $container->privates['App\\Repository\\GroupsRepository'] = new \App\Repository\GroupsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
