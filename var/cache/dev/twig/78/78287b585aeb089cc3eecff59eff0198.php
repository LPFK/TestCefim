...
class __TwigTemplate_364457957973987fc35d643431c9f26d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
      ...
      <small>";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "Nom", [], "any", false, false, false, 15), 'help');
        echo "</small>
...
";
    ...
    {
        return array (  119 => 20,  114 => 18,  108 => 15,  103 => 13,  99 => 12,  94 => 10,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"container\">
      ...
      {{ form_start(form) }}
      <div class=\"form-control\">
      <i class=\"fa fa-calendar\"></i> {{ form_label(form.Nom) }}
...
{% endblock %}", "homepage/index.html.twig", "C:\\Users\\LK\\ProjetWeb\\Symfony\\CefimTestWeek-main\\templates\\homepage\\index.html.twig");
    }
}
